...
bufrfile=$2
#####################################
### Set up restricted tanks table - DF may overwrite
######################################
export envir=${envir:-prod}
export rtank_tbl=${rtank_tbl:-/apps/ops/${envir}/nco/core/bufr_tranjb.v${bufr_tranjb_ver}/dictionaries/rstprod_bufr_tank.tbl}
